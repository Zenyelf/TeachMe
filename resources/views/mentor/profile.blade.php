...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display">
    <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <main class="flex-1 max-w-6xl mx-auto w-full px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <aside class="lg:col-span-3 flex flex-col gap-2">
                <div
                    class="p-4 mb-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div class="lg:col-span-9 space-y-8">
                ...
                <form action="{{ route('mentor.profile.update') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h1 class="text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Public
                                Profile</h1>
                            <p class="text-slate-500 mt-1 font-medium">Customize how students and partners see your
        ...
        <span class="material-symbols-outlined text-sm">photo_camera</span>
                        ...
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <div class="flex flex-wrap justify-center md:justify-start gap-3">
                                <span
                                    class="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold flex items-center gap-1">
                                    <span class="material-symbols-outlined text-sm">school</span>
                                    {{ auth()->user()->mentor->academic_degree ?? 'No Degree' }}
                                </span>
                                <span
                                    class="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold flex items-center gap-1">
                                    <span class="material-symbols-outlined text-sm">location_on</span>
                                    {{ auth()->user()->mentor->address ?? 'No Location' }}
                                </span>
                            </div>
                        </div>
    ...
    <input type="file" name="avatar" id="avatar-input-mentor" class="hidden" accept="image/*" onchange="previewMentorAvatar(event)">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Full
                                        Name</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Professional
                                        Title</label>
                                    <input type="text" name="title" value="{{ auth()->user()->mentor->title ?? '' }}"
                                        class="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg px-4 py-2.5 focus:ring-primary focus:border-primary">
                                </div>
                                <div>
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Academic
                                        Degree</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Address</label>
                        ...
                        <div
                            ...
                            <div class="space-y-4">
                                <p class="text-sm text-slate-500">Select how you prefer to deliver your mentoring
                                    sessions.</p>
                                <div class="space-y-2">
                                    <label
                                        class="flex items-center justify-between p-3 border border-slate-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <!-- Bio & Specialty -->
                        <div
                            class="md:col-span-2 bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
                            <h3 class="text-lg font-bold flex items-center gap-2">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Short
                                        Biography</label>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <span
                                        class="material-symbols-outlined absolute left-3 top-2.5 text-slate-400">mail</span>
                                    <input type="email" name="contact_email"
                                        value="{{ auth()->user()->mentor->contact_email ?? '' }}"
                                        ...
                                        placeholder="email.bisnis@example.com">
                                </div>
                            </div>
                            <div>
                                <label
                                    class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">LinkedIn
                                    Profile</label>
                                <div class="relative">
                                    <span
                                        class="material-symbols-outlined absolute left-3 top-2.5 text-slate-400">share</span>
                                    <input type="text" name="linkedin_url"
                                        value="{{ auth()->user()->mentor->linkedin_url ?? '' }}"
                                        class="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg pl-10 pr-4 py-2.5 focus:ring-primary focus:border-primary"
                            ...
                            <div>
                                <label
                                    class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Portfolio
                                    URL</label>
                                <div class="relative">
                                    <span
                                        class="material-symbols-outlined absolute left-3 top-2.5 text-slate-400">language</span>
                                    <input type="text" name="portfolio_url"
                                        value="{{ auth()->user()->mentor->portfolio_url ?? '' }}"
                                        class="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg pl-10 pr-4 py-2.5 focus:ring-primary focus:border-primary"
                            ...
                            <div>
                                <label
                                    class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Social
                                    Media (Optional)</label>
                                <div class="relative">
                                    <span
                                        class="material-symbols-outlined absolute left-3 top-2.5 text-slate-400">alternate_email</span>
                                    <input type="text" name="twitter_handle"
                                        value="{{ auth()->user()->mentor->twitter_handle ?? '' }}"
                                        class="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg pl-10 pr-4 py-2.5 focus:ring-primary focus:border-primary"
                    ...
                    <div class="flex justify-end gap-3 w-full">
                        <button
                            class="flex-1 md:flex-none px-6 py-2.5 rounded-lg border border-slate-200 dark:border-slate-800 font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">Discard</button>
                        <button type="submit"
                            class="flex-1 md:flex-none px-6 py-2.5 rounded-lg bg-primary text-white font-bold text-sm shadow-lg shadow-primary/20 hover:bg-primary/90 transition-colors">Save
                            Changes</button>
                    </div>
            </div>
    </div>
