                ...
                <main class="flex-1 flex justify-center py-8 px-4 md:px-10">
                    <div class="max-w-[1000px] w-full space-y-8">
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-slate-500 dark:text-slate-400">Manage your educational journey and account
                                preferences.</p>
                        </div>
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div class="lg:col-span-1 space-y-6">
                                ...
                                <div
                                    class="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 space-y-4">
                                    <h3 class="font-bold text-lg">Notification Preferences</h3>
                                    <div class="space-y-3">
                                        <label class="flex items-center justify-between cursor-pointer">
                                            <span class="text-sm">Course Updates</span>
                                            <input checked=""
                                                class="w-10 h-5 rounded-full appearance-none bg-slate-300 checked:bg-primary relative transition-all before:content-[''] before:absolute before:w-4 before:h-4 before:bg-white before:rounded-full before:top-0.5 before:left-0.5 checked:before:left-5 before:transition-all"
                                                type="checkbox" />
                                        </label>
                                        <label class="flex items-center justify-between cursor-pointer">
           ...
           placeholder="Contoh: Artificial Intelligence, Cyber Security, atau Web Development">
                                ...
                                <div
                                    ...
                                    <div class="mt-6 flex justify-end gap-3">
                                        <button
                                            class="px-6 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 font-semibold hover:bg-slate-50 transition-colors">Cancel</button>
                                        <button type="submit"
                                            class="px-6 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-blue-700 shadow-md shadow-primary/20 transition-all">Save
                                            Changes</button>
                                    </div>
                                </div>
                            </div>
