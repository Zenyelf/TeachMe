        ...
        <main class="flex-1 w-full max-w-[1200px] mx-auto px-6 md:px-20 py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="col-span-full py-20 text-center">
                    ...
                    <a href="{{ route('courses.index') }}" class="px-6 py-3 bg-primary text-white rounded-xl font-bold">
                        Browse Courses
                    </a>
                </div>
                @endforelse
            ...
            <div class="max-w-[1200px] mx-auto px-6 md:px-20">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <p class="text-slate-500 text-xs font-semibold uppercase tracking-widest">Certificates Earned
                        </p>
                    </div>
                    <div class="text-center md:text-left">
