        ...
        <aside
            ...
            <div class="p-4 border-t border-slate-200 dark:border-slate-800">
                <a href="{{ route('student.profile') }}"
                    ...
                    <div class="size-10 rounded-full bg-primary/20 bg-center bg-cover"
                        data-alt="Student profile picture smiling"
                        style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuC4PkJXvnSo_C7vJEdHtGkhFOnOF-GbqweQO6v5fUbJgGMsGbUlJpJ8-2FJj2PZKnsUt-GPo9SFiwCmdBEwl836qeG8eKT-wVCKcs2_Ca7UvV6FgPF844iAdeOVgPt0bfDf4qzXv1u-8Yd8pMBvDQ8-k8dxqOap7e9AXp_ESrC-di22zGQ7DWhVrddLV2ittYJ7Lbcpux4ZIj8U34pLZ9g7Vxz9-Yy5CU7LdcjJdM2AplYsZSoE7ZFEZfBduH1wW25vA_5oQLCIc2A')">
                    </div>
            ...
            <div class="max-w-6xl mx-auto p-8">
                ...
                <section
                    ...
                    <div class="relative z-10 max-w-lg">
                        ...
                        <p class="text-blue-50/80 mb-6">You've completed 75% of your Weekly Calculus goal. Keep up the
                            great work!</p>
                ...
                <section class="mb-12">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ url('/my-course') }}" class="text-primary font-semibold text-sm hover:underline"
                            href="#">View All</a>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Course Card 1 -->
                        <div
                            class="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span
                                    class="px-3 py-1 bg-green-100 text-green-700 text-[10px] font-bold uppercase rounded-full tracking-wider">In
                                    Progress</span>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span
                                    class="px-3 py-1 bg-primary/10 text-primary text-[10px] font-bold uppercase rounded-full tracking-wider">Upcoming</span>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span
                                    class="px-3 py-1 bg-slate-100 text-slate-700 text-[10px] font-bold uppercase rounded-full tracking-wider">Paused</span>
                            </div>
                ...
                <section>
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex gap-2">
                            <button
                                class="p-2 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="group cursor-pointer">
                            <div class="aspect-video w-full rounded-xl overflow-hidden mb-3 relative">
                                <div class="absolute inset-0 bg-slate-200 bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Zen yoga studio with mats"
                        ...
                        <div class="group cursor-pointer">
                            <div class="aspect-video w-full rounded-xl overflow-hidden mb-3 relative">
                                <div class="absolute inset-0 bg-slate-200 bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Mathematics formulas on chalkboard"
                                ...
                                <div
                                    class="absolute bottom-2 left-2 px-2 py-1 bg-orange-500 text-white text-[10px] font-bold uppercase rounded tracking-tighter">
                                    Academic</div>
                            </div>
                            <h5
                                class="font-bold text-slate-900 dark:text-slate-100 line-clamp-2 group-hover:text-primary transition-colors">
                                Quantum Physics Foundations</h5>
                        ...
                        <div class="group cursor-pointer">
                            <div class="aspect-video w-full rounded-xl overflow-hidden mb-3 relative">
                                <div class="absolute inset-0 bg-slate-200 bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Karate uniform and belt"
                        ...
                        <div class="group cursor-pointer">
                            ...
                            <h5
                                class="font-bold text-slate-900 dark:text-slate-100 line-clamp-2 group-hover:text-primary transition-colors">
                                Organic Chemistry Lab Techniques</h5>
