...
<button onclick="window.location.href='/register'" class="bg-white text-primary px-8 py-4 rounded-xl font-extrabold text-lg hover:bg-blue-50 transition-colors">
    Join as Student
</button>
