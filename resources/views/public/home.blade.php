...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100">
                ...
                <div class="flex flex-1 justify-end items-center gap-4">
                    <form action="{{ route('courses.index') }}" method="GET"
                        ...
                        <input name="search" value="{{ request('search') }}"
                            class="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary focus:outline-none"
    ...
    <main>
        <!-- Hero Section -->
        <section
            class="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white dark:from-slate-900 dark:to-background-dark py-20 lg:py-32">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="flex flex-col gap-8">
                        <div
                            class="inline-flex items-center gap-2 bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                            <span class="material-symbols-outlined text-sm">stars</span>
                            The Global Learning Marketplace
                        </div>
                        <h1
                            class="text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight text-slate-900 dark:text-white">
                        ...
                        <p class="text-lg text-slate-600 dark:text-slate-400 max-w-xl leading-relaxed">
                            Empowering learners and mentors across Academics, Martial Arts, and Sports. Join the premier
                        ...
                        <div class="flex items-center gap-4 pt-4">
                            <div class="flex -space-x-2">
                                <div class="w-10 h-10 rounded-full border-2 border-white bg-slate-200"
                                    data-alt="Student profile avatar 1"></div>
                                <div class="w-10 h-10 rounded-full border-2 border-white bg-slate-300"
                                    data-alt="Student profile avatar 2"></div>
                                <div class="w-10 h-10 rounded-full border-2 border-white bg-slate-400"
                                    data-alt="Student profile avatar 3"></div>
                            </div>
                    ...
                    <div class="relative group">
                        <div
                            class="absolute -inset-4 bg-primary/20 rounded-3xl blur-3xl group-hover:bg-primary/30 transition-colors">
                        </div>
                        <div class="relative aspect-video lg:aspect-square bg-slate-200 dark:bg-slate-800 rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700"
                            data-alt="Diverse students studying together on campus"
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent flex flex-col justify-end p-8">
                                <div class="flex gap-2">
                                    <span
                                        class="bg-white/20 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs font-semibold">Academics</span>
                                    <span
                                        class="bg-white/20 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs font-semibold">Martial
                                        Arts</span>
                                    <span
                                        class="bg-white/20 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs font-semibold">Sports</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-24 bg-white dark:bg-background-dark">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <h3 class="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white mb-4">Start Your
                        Learning Journey</h3>
                    <p class="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Unlock your potential with our
                        easy-to-use platform designed for modern learners seeking mastery in any field.</p>
                </div>
                <div class="grid md:grid-cols-3 gap-8">
                    <div onclick="window.location.href='{{ url('/register') }}'"
                        class="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 hover:border-primary/50 transition-all group">
                        <div
                            class="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                            <span class="material-symbols-outlined text-3xl">travel_explore</span>
                        </div>
                        <h4 class="text-xl font-bold mb-3">Discover</h4>
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Find thousands of courses tailored
                            to your goals in academics, competitive sports, and traditional arts.</p>
                    </div>
                    <div onclick="window.location.href='{{ url('/register') }}'"
                        class="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 hover:border-primary/50 transition-all group">
                        <div
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Instantly schedule sessions that
                            fit your busy lifestyle. Manage all your learning in one integrated dashboard.</p>
                    </div>
                    <div onclick="window.location.href='{{ url('/register') }}'"
                        class="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 hover:border-primary/50 transition-all group">
                        <div
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">Connect with vetted experts and
                            master new skills through high-quality 1-on-1 or group interactions.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div class="order-2 lg:order-1">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-4">
                                <div class="aspect-square rounded-2xl bg-slate-200 dark:bg-slate-800"
                                    data-alt="Martial arts instructor teaching a student"
                                ...
                                <div
                                    class="aspect-[3/4] rounded-2xl bg-primary/20 flex flex-col items-center justify-center text-center p-6 border border-primary/10">
                    ...
                    <div class="order-1 lg:order-2">
                        ...
                        <h3 class="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white mb-6">Monetize
                            Your Expertise</h3>
                        <div class="space-y-8">
                            <div class="flex gap-4">
                                <div
                                    class="flex-shrink-0 w-10 h-10 bg-white dark:bg-slate-800 shadow-sm rounded-lg flex items-center justify-center text-primary border border-slate-100 dark:border-slate-700">
                                    <span class="material-symbols-outlined font-bold">draw</span>
                                </div>
                                <div>
                                    <h4 class="text-lg font-bold mb-1">Teach</h4>
                                    <p class="text-slate-600 dark:text-slate-400">Reach a global audience of students
                                        eager to learn what you know. Flexible tools for any curriculum.</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-600 dark:text-slate-400">Set your own rates and get paid
                                        instantly. Our platform handles the billing and payouts securely.</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-600 dark:text-slate-400">Build trust with our comprehensive
                                        verification system and display your credentials proudly.</p>
                                </div>
                            </div>
                        </div>
                        <button onclick="window.location.href='/register?role=Mentor'"
        ...
        <section class="py-20">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    class="relative overflow-hidden rounded-[2.5rem] bg-primary px-8 py-16 text-center text-white shadow-2xl shadow-primary/30">
                    <div class="absolute inset-0 opacity-10"
                        style="background-image: radial-gradient(circle at 2px 2px, white 1px, transparent 0); background-size: 40px 40px;">
                    </div>
                    <div class="relative z-10">
                        <h2 class="text-3xl lg:text-5xl font-black mb-6">Ready to expand your horizons?</h2>
                        <p class="text-lg text-blue-100 mb-10 max-w-2xl mx-auto">Join thousands of others on the world's
